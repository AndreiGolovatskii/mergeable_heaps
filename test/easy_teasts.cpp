...
// TEST(LeftistHeapTest, insertAndErase) {
//   insertAndEraseTest<LeftistHeap<int>>();
// }

// TEST(LeftistHeapTest, merge) {
//   mergeTest<LeftistHeap<int>>();
// }

// TEST(LeftistHeapTest, copyAndMove) {
//   copyAndMoveTest<LeftistHeap<int>>();
// }

// TEST(LeftistHeapTest, pointerIHeap) {
//   pointerIHeap<LeftistHeap<int>>();
// }
 
// //-----

// TEST(SkewHeapTest, insertAndErase) {
//   insertAndEraseTest<SkewHeap<int>>();
// }

// TEST(SkewHeapTest, merge) {
//   mergeTest<SkewHeap<int>>();
// }

// TEST(SkewHeapTest, copyAndMove) {
//   copyAndMoveTest<SkewHeap<int>>();
// }

// TEST(SkewHeapTest, pointerIHeap) {
//   pointerIHeap<SkewHeap<int>>();
// }